...
@section('content')
    ...
    <form action="/admins" method="post" class="needs-validation" novalidate>
        {{ csrf_field() }}
        <div class="form-group row">
            ...
            <div class="col-md-6 mb-3">
                <input name="name" type="text" class="form-control {{ $errors->has('name') ? 'is-invalid' : ''}}"
                       id="nickname" placeholder="nickname" value="{{ old('name') }}" required>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6  mb-3">
                <input name="email" type="email" class="form-control {{ $errors->has('email') ? 'is-invalid' : ''}}" id="email" placeholder="name@example.com"
                       required>
                <span class="invalid-tooltip">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6 mb-3">
                <input name="password_confirmation" type="password" class="form-control {{ $errors->has('password_confirmation') ? 'is-invalid' : ''}}" id="password_confirmation" required>
                <span class="invalid-tooltip">
